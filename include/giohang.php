...
if(isset($_POST['themgiohang'])){
    ...
    if($count>0){
        ...
        $soluong = $soluong;
        $sql_giohang = "INSERT INTO tbl_giohang(tensanpham,sanpham_id,giasanpham,hinhanh,soluong) value('$tensanpham','$sanpham_id','$gia','$hinhanh','$soluong')";
    }
	...
	$sql_khachhang = mysqli_query($con,"INSERT INTO tbl_khachhang(name,phone,email,note,address,giaohang) values('$name','$phone','$email','$note','$address','$giaohang')");
	if($sql_khachhang){
                        ...
                        ?>
							<tr class="rem1">
								...
								<td class="invert-image">
									<a href="single.html">
										<img src="images/<?php echo $row_fetch_giohang['hinhanh']?>" alt=" " height="130px" class="img-responsive">
									</a>
								</td>
								<td class="invert">
                            ...
                            <tr>
                                <td colspan="7"><input type="submit" style="background-color: green;" value="Cập nhật" name="capnhatsoluong"></td>
                            </tr>
					...
					<form action="" method="post" class="creditly-card-form agileinfo_form">
						<div class="creditly-wrapper wthree, w3_agileits_wrapper">
							<div class="information-wrapper">
								...
								?>
								<input type="submit" name="thanhtoan" class="btn btn-success" style="width: 20%" value="Thanh toan">
							</div>
						</div>
					</form>
